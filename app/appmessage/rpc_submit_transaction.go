...
// RPCTransaction is a frind transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a frind transaction input representation
...
// RPCScriptPublicKey is a frind ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a frind transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a frind outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a frind utxo entry representation meant to be used
// over RPC
