...
import (
	...
	"github.com/frin-network/frind/cmd/frinwallet/libkaspawallet/bip32"
	"github.com/frin-network/frind/cmd/frinwallet/utils"
	"github.com/pkg/errors"

	"github.com/frin-network/frind/cmd/frinwallet/keys"
)
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"frinwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"frinwallet new-address\" to create and see one)\n\n")
