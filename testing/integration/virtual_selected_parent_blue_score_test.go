...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := frind.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = frind.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = frind.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
