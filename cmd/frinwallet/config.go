...
type createConfig struct {
	KeysFile          string `long:"keys-file" short:"f" description:"Keys file location (default: ~/.frinwallet/keys.json (*nix), %USERPROFILE%\\AppData\\Local\\frinwallet\\key.json (Windows))"`
