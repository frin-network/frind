...
import (
	...
	"github.com/frin-network/frind/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that frind doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
