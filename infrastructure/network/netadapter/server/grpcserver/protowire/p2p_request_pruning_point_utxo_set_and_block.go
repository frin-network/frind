...
func (x *frindMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "frindMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *frindMessage_RequestPruningPointUTXOSet) fromAppMessage(
