...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/frin-network/frind/database)

Package database provides a database for frind.
...
DataAccessor
------------
This defines the common interface by which data gets accessed in a generic frind
...
Transaction
-----------
This defines the interface of a generic frind database transaction.
