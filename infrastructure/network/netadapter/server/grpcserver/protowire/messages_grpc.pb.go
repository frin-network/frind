...
type P2P_MessageStreamClient interface {
	Send(*frindMessage) error
	Recv() (*frindMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *frindMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*frindMessage, error) {
	m := new(frindMessage)
...
func (x *p2PMessageStreamServer) Send(m *frindMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*frindMessage, error) {
	m := new(frindMessage)
...
func (x *rPCMessageStreamClient) Send(m *frindMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*frindMessage, error) {
	m := new(frindMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *frindMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*frindMessage, error) {
	m := new(frindMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
