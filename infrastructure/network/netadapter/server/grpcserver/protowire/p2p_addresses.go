...
func (x *frindMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "frindMessage_Addresses is nil")
	}
...
func (x *frindMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
