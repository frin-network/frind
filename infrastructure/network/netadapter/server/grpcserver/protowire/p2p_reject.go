...
func (x *frindMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "frindMessage_Reject is nil")
	}
...
func (x *frindMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
