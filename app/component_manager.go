...
import (
	...
	"github.com/frin-network/frind/domain/miningmanager/mempool"

	"github.com/frin-network/frind/app/protocol"
	"github.com/frin-network/frind/app/rpc"
	"github.com/frin-network/frind/domain"
	"github.com/frin-network/frind/domain/consensus"
	"github.com/frin-network/frind/domain/utxoindex"
	...
	"github.com/frin-network/frind/infrastructure/network/connmanager"
	"github.com/frin-network/frind/infrastructure/network/netadapter"
	"github.com/frin-network/frind/infrastructure/network/netadapter/id"
	"github.com/frin-network/frind/util/panics"
)

// ComponentManager is a wrapper for all the frind services
...
// Start launches all the frind services.
...
// Stop gracefully shuts down all the frind services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Frind is already in the process of shutting down")
		return
	}

	log.Warnf("Frind shutting down")
