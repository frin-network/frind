...
func (x *frindMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "frindMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *frindMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
