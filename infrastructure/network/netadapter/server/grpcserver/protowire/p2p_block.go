...
func (x *frindMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "frindMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *frindMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
