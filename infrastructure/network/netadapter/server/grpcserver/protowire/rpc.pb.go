...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether frind thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when frind is not synced.
	// That is because when frind isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this frind initiated the connection
	...
	// The timestamp of when this peer connected to this frind
