...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/frin-network/research/issues/3
...
var MainnetParams = Params{
	...
	DNSSeeds: []string{
		// Team DNS seed
		"mainnet-dnsseed-1.frincoin.com",
		"mainnet-dnsseed-2.frincoin.com",
	},
