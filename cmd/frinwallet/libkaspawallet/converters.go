...
func KaspawalletdUTXOsTolibkaspawalletUTXOs(frinwalletdUtxoEntires []*pb.UtxosByAddressesEntry) ([]*UTXO, error) {
	UTXOs := make([]*UTXO, len(frinwalletdUtxoEntires))
	for i, entry := range frinwalletdUtxoEntires {
