...
// installService attempts to install the frind service. Typically this should
...
// removeService attempts to uninstall the frind service. Typically this should
...
// startService attempts to Start the frind service.
