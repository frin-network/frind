...
type grpcStream interface {
	Send(*protowire.frindMessage) error
	Recv() (*protowire.frindMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.frindMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.frindMessage) error {
