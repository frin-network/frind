...
func (x *frindMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "frindMessage_Version is nil")
	}
...
func (x *frindMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
