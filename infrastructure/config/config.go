...
import (
	...
	"github.com/frin-network/frind/util/network"
	"github.com/frin-network/frind/version"
	"github.com/pkg/errors"
)

const (
	defaultConfigFilename      = "frind.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "frind.log"
	defaultErrLogFilename      = "frind_err.log"
	...
	sampleConfigFilename    = "sample-frind.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for frind.
	DefaultAppDir = util.AppDir("frind", false)
...
// Flags defines the configuration options for frind.
//
...
// Config defines the configuration options for frind.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default frind configuration
...
//
// The above results in frind functioning properly without any config settings
...
// createDefaultConfig copies the file sample-frind.conf to the given destination path,
